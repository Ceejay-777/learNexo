...
const StepsToUse = ({ image, index, step, info, reverse }) => {
  return (
    ...
    >
      <img src={image} className="w-1/3 h-full max-w-[320px]" />
      <div className="flex flex-col md:gap-4 justify-between h-fit border-b-1 border-[#B4B4B4] pb-4 mx-12 sm:mx-0">
